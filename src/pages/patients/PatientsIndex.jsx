...
export default function PatientsIndex() {
  ...
  return <section className="routed-page clinical-index-page">
    <PageHeader eyebrow="PHASE 2 · PATIENT MANAGEMENT" title="Patient registry" description="Search and maintain authorized patient records with clear care-relevant detail." crumbs={[{ label: 'Patients' }]} action={can('patients.create') && <Link className="btn-ledger-primary" to="/patients/new">Add patient</Link>} />
