...
const groups = [
  ...
  { label: 'DIAGNOSTIC CENTER', items: [{ to: '/diagnostic-orders', label: 'Diagnostic orders', icon: FileText, permission: 'diagnostic-orders.view' }, { to: '/diagnostic-tests', label: 'Diagnostic tests', icon: FlaskConical, permission: 'diagnostic-tests.view' }] },
